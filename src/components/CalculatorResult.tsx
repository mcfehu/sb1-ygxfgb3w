      ...
      <div className="p-6 space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-2xl font-bold text-gray-900">
            {result.positionSize.toFixed(4)} {result.unit}
          </p>
        </div>
          ...
          <div className="space-y-2">
            ...
            {showExchangeRateNote && (
              <p className="text-amber-600">
                Calculations use a static exchange rate of {exchangeRates[result.currency]} {result.currency}/USD. 
                Please verify current rates with your broker.
              </p>
            )}
          </div>
        </div>
